...
const TableProgressCard = ({ table, stats }: TableProgressCardProps) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-amber-100 p-3 shadow-sm">
      <div className="flex items-center justify-between mb-2">
        <span className="font-bold text-amber-800 text-base">Tafel van {table}</span>
        <span className={`font-bold text-sm ${getAccuracyColor()}`}>
          {accuracy}%
        </span>
      </div>
